...
The station logos included in `app/src/main/res/drawable-nodpi/` were obtained from Mediacorp's public station assets:

| Station | Station page | Logo source |
| --- | --- | --- |
| YES 933 | https://data.melisten.sg/radio/yes-933 | https://www16.mediacorp.sg/melisten/radiostation-logos/yes-933.png |
